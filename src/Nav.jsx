...
const Navbar = () => {
    ...
    return (  <>
       <nav className="absolute left-5 top-5 flex justify-between items-center bg-none w-[90%]">
        <a href="/">
          {" "}
          <h1 className=" text-5xl font-bold text-gray-400 ">JO</h1>
        </a>
        <svg
        ...
        <p className="block md:hidden">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className=" w-7 cursor-pointer hover:fill-slate-400"
            viewBox="0 0 512 512"
          ...
          >
            <p className="block md:hidden ">
              <svg
                ...
                viewBox="0 0 512 512"
                onClick={HandleToggle}
                className=" w-7 fill-white hover:fill-slate-400 mt-3 ml-5 cursor-pointer "
              >
            ...
            <section className="  text-white flex justify-center items-center flex-col h-[80vh] text-3xl">
              <a
                href="/"
                className=" space-x-4  border-b-2 p-2 w-[50%] text-center hover:bg-slate-50 dark:hover:bg-white hover:text-black hover:opacity-[0.8] transition-all ease-in duration-100"
              >
                Home
              </a>
              <a
