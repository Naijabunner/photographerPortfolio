...
const Navbar = () => {
    ...
    return (  <>
       <nav className="absolute left-5 top-5 flex justify-between items-center bg-none w-[90%]">
        <a href="/">
          {" "}
          <h1 className="text-3xl md:text-5xl font-bold text-gray-400 font-mono  dark:text-[#fff]">JO STUDIO</h1>
        </a>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="absolute top-1 left-20 hidden w-5 fill-gray-400  dark:fill-white text-5xl font-bold text-gray-400"
          viewBox="0 0 384 512"
        >
          <path d="M272 384c9.6-31.9 29.5-59.1 49.2-86.2l0 0c5.2-7.1 10.4-14.2 15.4-21.4c19.8-28.5 31.4-63 31.4-100.3C368 78.8 289.2 0 192 0S16 78.8 16 176c0 37.3 11.6 71.9 31.4 100.3c5 7.2 10.2 14.3 15.4 21.4l0 0c19.8 27.1 39.7 54.4 49.2 86.2H272zM192 512c44.2 0 80-35.8 80-80V416H112v16c0 44.2 35.8 80 80 80zM112 176c0 8.8-7.2 16-16 16s-16-7.2-16-16c0-61.9 50.1-112 112-112c8.8 0 16 7.2 16 16s-7.2 16-16 16c-44.2 0-80 35.8-80 80z" />
        </svg>

        <div className="navLinks text-lg lg:text-2xl font-medium md:flex justify-center items-center  hidden">
          ...
          <a href="/gallery" className="relative bg-transparent">
            <div className={theme === "dark"? "hoverDark":"hover"}>
              <p className="mx-5  dark:text-[#ffff]"> Gallery </p>
            </div>
          </a>
          <a href="/About" className="relative bg-transparent">
            <div className={theme === "dark"? "hoverDark":"hover"}>
              <p className="mx-5  dark:text-[#ffff]"> About Me </p>
            </div>
          </a>
      ...
      <AnimatePresence>
        {isvisible && (
          <MiniNav HandleToggle={HandleToggle}/>
        )}
      </AnimatePresence>
    </>);
}
  ...
  return(
    <motion.nav
          ...
          >
            ...
            <section className=" text-black dark:text-[#ffff] flex justify-center items-center flex-col h-[80vh] text-xl md:text-3xl">
              <a
                href="/"
