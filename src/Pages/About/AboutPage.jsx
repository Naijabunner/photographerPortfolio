...
const AboutBlock = () => (
  <Block className="col-span-12 mt-14 text-xl sm:text-2xl leading-snug dark:bg-zinc-800 bg-zinc-50">
          <img src={image} className=" sm:float-end ml-3 w-40 rounded-lg" alt="" />
